...
- **Dynamic Exercise-Specific Form & ROM Correction**: Performs real-time execution audits including shoulder-elbow symmetry, shoulder press incomplete lockouts, biceps curl elbow swing (momentum cheating), push-up and bench press elbow flare (protecting rotator cuffs), straight leg raise elevated height bounds (preventing lumbar strain), and glute bridge hyperextension.
