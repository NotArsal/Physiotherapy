...
export const EXERCISE_DEMOS: Record<string, ExerciseDemo> = {
  bench_press: {
    images: ['/exercises/gifs/0025-EIeI8Vf.gif'],
  ...
  incline_bench_press: {
    images: ['/exercises/gifs/0047-3TZduzM.gif'],
  ...
  decline_bench_press: {
    images: ['/exercises/gifs/0033-GrO65fd.gif'],
  ...
  push_up: {
    images: ['/exercises/gifs/0975-ufaxB52.gif'],
  ...
  squat: {
    images: ['/exercises/gifs/0043-qXTaZnJ.gif'],
  ...
  deadlift: {
    images: ['/exercises/gifs/0032-ila4NZS.gif'],
  ...
  romanian_deadlift: {
    images: ['/exercises/gifs/0085-wQ2c4XD.gif'],
  ...
  t_bar_row: {
    images: ['/exercises/gifs/1349-BgljGjd.gif'],
  ...
  lateral_raise: {
    images: ['/exercises/gifs/0334-DsgkuIt.gif'],
  ...
  tricep_dips: {
    images: ['/exercises/gifs/0019-J60bN17.gif'],
  ...
  tricep_pushdown: {
    images: ['/exercises/gifs/2406-ThKP69G.gif'],
  ...
  plank: {
    images: ['/exercises/gifs/0464-CosupLu.gif'],
  ...
  russian_twist: {
    images: ['/exercises/gifs/0014-r7cT9YD.gif'],
  ...
  leg_extension: {
    images: ['/exercises/gifs/0585-my33uHU.gif'],
  ...
  leg_raises: {
    images: ['/exercises/gifs/0472-I3tsCnC.gif'],
  ...
  glute_bridge: {
    images: ['/exercises/gifs/1409-qKBpF7I.gif'],
  ...
  straight_leg_raise: {
    images: ['/exercises/gifs/1002-bbLR7fB.gif'],
